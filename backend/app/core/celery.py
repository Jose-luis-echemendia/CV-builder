...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "app.workers.tasks.pdf_tasks.generate_cv_pdf": {
            "queue": "pdf",
            "routing_key": "pdf",
        },
        # Mantenimiento periódico → baja prioridad
        "app.workers.tasks.cleanup_tasks.cleanup_expired_pdfs": {
            "queue": "maintenance",
            "routing_key": "maintenance",
        },
        "app.workers.tasks.cleanup_tasks.cleanup_stale_building_cvs": {
            "queue": "maintenance",
            "routing_key": "maintenance",
        },
    },
